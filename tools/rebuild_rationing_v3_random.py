...
# ------------------------------------------------------------- activation
p8("배급제 활성화: 미션2 진행(Valkyrie=3) + 90초(마스터 틱 1080) 경과",
   [dc("Terran Valkyrie", "Exactly", 3) + " //미션2 진행 단계",
    dc("Terran Vulture", "At least", 1080) + " //미션2 +90초",
    sw(177, "Not Set") + " //아직 비활성"],
   [set_sw(177, "set") + " //전시 배급제 가동"])

trig("All Players", "활성화 안내 1: 노바 (틱 1080~1104 창)",
     [dc("Terran Valkyrie", "Exactly", 3),
      dc("Terran Vulture", "At least", 1080),
      dc("Terran Vulture", "At most", 1104)],
     ['Display Text Message(Always Display, "<1A>노바: <04>전선 전체의 물자 압박이 한계에 가깝습니다. 부족 전선부터 배급 통제를 실시할 수 있습니다.");'],
     preserve=False)

trig("All Players", "활성화 안내 2: 호크 (틱 1164~1188 창)",
     [dc("Terran Valkyrie", "Exactly", 3),
      dc("Terran Vulture", "At least", 1164),
      dc("Terran Vulture", "At most", 1188)],
     ['Display Text Message(Always Display, "<03>호크: <04>좋다. 전시 배급제로 전환한다. 남는 물자는 통제해서 부족한 지휘관에게 우선 돌려라.");'],
     preserve=False)

trig("All Players", "활성화 안내 3: 시스템 규칙 요약 (틱 1272~1296 창)",
     [dc("Terran Valkyrie", "Exactly", 3),
