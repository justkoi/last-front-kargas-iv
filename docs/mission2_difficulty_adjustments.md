...
- `1 = easy`: first and repeated P6/P7 main assaults use the 32:15 / 33:00 / 33:45 cooldown band, main-assault base waves are reduced by about 20%, Hatchery/Lair/Hive kills accelerate that colony by 198 seconds, and Overmind Cocoon side selection always picks P6 when both colonies are still alive.
